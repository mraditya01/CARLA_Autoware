...
void MappingUtils::llaToxyz(const std::string& proj_str, const WayPoint& origin, const double& lat,
...
void GnssInterface::GnssCallBack(const sensor_msgs::msg::NavSatFix::SharedPtr msg)
{
	...
	interface::gnss::WayPoint org, p;
	interface::gnss::MappingUtils::llaToxyz("+proj=tmerc +lat_0=0 +lon_0=0 +k=0.9999 +x_0=0 +y_0=0 +ellps=GRS80 +units=m +no_defs", org, msg->latitude, msg->longitude, msg->altitude, p.pos.x, p.pos.y, p.pos.z);	
